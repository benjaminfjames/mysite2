...
For example, if I wanted to start a new project named "mysite2" I would enter the following:
```
django-admin startproject --template=http://github.com/usma-it394/it394_project_template/archive/master.zip mysite2
cd mysite2
.\fix_name.ps1 -name "mysite2"
```
